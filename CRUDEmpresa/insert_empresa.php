...
$email = $_POST['email'];
//Declaramos la variable que recogerá nuestra sentencia de insertar, en este caso, de la empresa que tenga ese nombre, e introduciremos las variables que hemos declarado antes
//con los valores que el usuario ha introducido en el formulario.
$sql="INSERT INTO empresa(nombre,direccion,telefono,email)VALUES
